...
This repository contains the complete implementation of **DERS-X (Distress Emotion Recognition System - Extended)** , a reproducible benchmark protocol for calibrated multimodal affect modeling from speech and text. The framework integrates:
...
The study focuses on a benchmark-specific distress-like affect construct derived from dimensional affect annotations in public speech-emotion corpora and does not claim clinical, operational, or emergency-call distress detection.
...
|---------|-------------|--------------|
| **IEMOCAP** | Interactive Emotional Dyadic Motion Capture Database – acted and improvised dyadic interactions with categorical emotion labels and dimensional affect ratings | https://sail.usc.edu/iemocap/ |
| **MSP-Podcast** | Naturalistic podcast speech with continuous arousal-valence annotations | https://lab-msp.com/MSP/MSP-Conversation.html |
| **MUSAN** | Music, Speech, and Noise Corpus (used for degradation experiments) | https://www.openslr.org/17/ |
...
# Run evaluation
python scripts/show_results.py --method checkpoint --checkpoint checkpoints/best_model.pt --config configs/default_config.yaml